...
import LogoEcoute from "@/public/assets/img/LogoEcoute.png"; // Path to your image
  ...
  return (
    <main className={`${MonsterratFont.className} h-screen flex flex-col`}>
      ...
      <div className="flex-grow relative">
        ...
        <div className="absolute bottom-0 left-0 w-screen h-[40%] lg:h-[50%]">
  <svg
    id="Layer_1"
    data-name="Layer 1"
  ...
  >
    ...
    />
        ...
        {/* <div className="absolute bottom-0 left-0 right-0">
          <Image src={LogoEcoute} alt="Ecoute Logo" layout="responsive" objectFit="contain" />
        </div> */}
      </div>
    </main>
  )
